...
procedure CkRsa_getDebugLogFilePath(objHandle: HCkRsa;
  outPropVal: HCkString); stdcall;

procedure CkRsa_putDebugLogFilePath(objHandle: HCkRsa;
  newPropVal: PWideChar); stdcall;

function CkRsa__debugLogFilePath(objHandle: HCkRsa): PWideChar; stdcall;

procedure CkRsa_getEncodingMode(objHandle: HCkRsa;
  outPropVal: HCkString); stdcall;

procedure CkRsa_putEncodingMode(objHandle: HCkRsa;
  newPropVal: PWideChar); stdcall;

function CkRsa__encodingMode(objHandle: HCkRsa): PWideChar; stdcall;

procedure CkRsa_getLastErrorHtml(objHandle: HCkRsa;
  outPropVal: HCkString); stdcall;

function CkRsa__lastErrorHtml(objHandle: HCkRsa): PWideChar; stdcall;

procedure CkRsa_getLastErrorText(objHandle: HCkRsa;
  outPropVal: HCkString); stdcall;

function CkRsa__lastErrorText(objHandle: HCkRsa): PWideChar; stdcall;

procedure CkRsa_getLastErrorXml(objHandle: HCkRsa;
  outPropVal: HCkString); stdcall;
...
procedure CkRsa_putLastMethodSuccess(objHandle: HCkRsa;
  newPropVal: wordbool); stdcall;

function CkRsa_getLittleEndian(objHandle: HCkRsa): wordbool; stdcall;

procedure CkRsa_putLittleEndian(objHandle: HCkRsa;
  newPropVal: wordbool); stdcall;
...
procedure CkRsa_getOaepMgfHash(objHandle: HCkRsa;
  outPropVal: HCkString); stdcall;

procedure CkRsa_putOaepMgfHash(objHandle: HCkRsa;
  newPropVal: PWideChar); stdcall;
...
procedure CkRsa_putOaepPadding(objHandle: HCkRsa;
  newPropVal: wordbool); stdcall;
...
procedure CkRsa_putVerboseLogging(objHandle: HCkRsa;
  newPropVal: wordbool); stdcall;
...
function CkRsa_DecryptBd(objHandle: HCkRsa; bd: HCkBinData;
  usePrivateKey: wordbool): wordbool; stdcall;

function CkRsa_DecryptBytes(objHandle: HCkRsa; inData: HCkByteData;
  usePrivateKey: wordbool; outData: HCkByteData): wordbool; stdcall;

function CkRsa_DecryptBytesENC(objHandle: HCkRsa; str: PWideChar;
  bUsePrivateKey: wordbool; outData: HCkByteData): wordbool; stdcall;

function CkRsa_DecryptString(objHandle: HCkRsa; binarySig: HCkByteData;
  usePrivateKey: wordbool; outStr: HCkString): wordbool; stdcall;

function CkRsa__decryptString(objHandle: HCkRsa; binarySig: HCkByteData;
  usePrivateKey: wordbool): PWideChar; stdcall;

function CkRsa_DecryptStringENC(objHandle: HCkRsa; encodedSig: PWideChar;
  usePrivateKey: wordbool; outStr: HCkString): wordbool; stdcall;

function CkRsa__decryptStringENC(objHandle: HCkRsa; encodedSig: PWideChar;
  usePrivateKey: wordbool): PWideChar; stdcall;

function CkRsa_EncryptBd(objHandle: HCkRsa; bd: HCkBinData;
  usePrivateKey: wordbool): wordbool; stdcall;

function CkRsa_EncryptBytes(objHandle: HCkRsa; binaryData: HCkByteData;
  usePrivateKey: wordbool; outData: HCkByteData): wordbool; stdcall;

function CkRsa_EncryptBytesENC(objHandle: HCkRsa; data: HCkByteData;
  bUsePrivateKey: wordbool; outStr: HCkString): wordbool; stdcall;

function CkRsa__encryptBytesENC(objHandle: HCkRsa; data: HCkByteData;
  bUsePrivateKey: wordbool): PWideChar; stdcall;

function CkRsa_EncryptString(objHandle: HCkRsa; stringToEncrypt: PWideChar;
  usePrivateKey: wordbool; outData: HCkByteData): wordbool; stdcall;

function CkRsa_EncryptStringENC(objHandle: HCkRsa; str: PWideChar;
  bUsePrivateKey: wordbool; outStr: HCkString): wordbool; stdcall;

function CkRsa__encryptStringENC(objHandle: HCkRsa; str: PWideChar;
  bUsePrivateKey: wordbool): PWideChar; stdcall;

function CkRsa_ExportPrivateKey(objHandle: HCkRsa; outStr: HCkString)
  : wordbool; stdcall;
...
function CkRsa_ExportPublicKey(objHandle: HCkRsa; outStr: HCkString)
  : wordbool; stdcall;
...
function CkRsa_GenerateKey(objHandle: HCkRsa; numBits: Integer)
  : wordbool; stdcall;

function CkRsa_ImportPrivateKey(objHandle: HCkRsa; xmlKey: PWideChar)
  : wordbool; stdcall;

function CkRsa_ImportPrivateKeyObj(objHandle: HCkRsa; key: HCkPrivateKey)
  : wordbool; stdcall;

function CkRsa_ImportPublicKey(objHandle: HCkRsa; xmlKey: PWideChar)
  : wordbool; stdcall;

function CkRsa_ImportPublicKeyObj(objHandle: HCkRsa; key: HCkPublicKey)
  : wordbool; stdcall;

function CkRsa_OpenSslSignBd(objHandle: HCkRsa; bd: HCkBinData)
  : wordbool; stdcall;

function CkRsa_OpenSslSignBytes(objHandle: HCkRsa; data: HCkByteData;
  outData: HCkByteData): wordbool; stdcall;

function CkRsa_OpenSslSignBytesENC(objHandle: HCkRsa; data: HCkByteData;
  outStr: HCkString): wordbool; stdcall;

function CkRsa__openSslSignBytesENC(objHandle: HCkRsa; data: HCkByteData)
  : PWideChar; stdcall;

function CkRsa_OpenSslSignString(objHandle: HCkRsa; str: PWideChar;
  outData: HCkByteData): wordbool; stdcall;

function CkRsa_OpenSslSignStringENC(objHandle: HCkRsa; str: PWideChar;
  outStr: HCkString): wordbool; stdcall;

function CkRsa__openSslSignStringENC(objHandle: HCkRsa; str: PWideChar)
  : PWideChar; stdcall;

function CkRsa_OpenSslVerifyBd(objHandle: HCkRsa; bd: HCkBinData)
  : wordbool; stdcall;

function CkRsa_OpenSslVerifyBytes(objHandle: HCkRsa; signature: HCkByteData;
  outData: HCkByteData): wordbool; stdcall;

function CkRsa_OpenSslVerifyBytesENC(objHandle: HCkRsa; str: PWideChar;
  outData: HCkByteData): wordbool; stdcall;

function CkRsa_OpenSslVerifyString(objHandle: HCkRsa; data: HCkByteData;
  outStr: HCkString): wordbool; stdcall;

function CkRsa__openSslVerifyString(objHandle: HCkRsa; data: HCkByteData)
  : PWideChar; stdcall;

function CkRsa_OpenSslVerifyStringENC(objHandle: HCkRsa; str: PWideChar;
  outStr: HCkString): wordbool; stdcall;

function CkRsa__openSslVerifyStringENC(objHandle: HCkRsa; str: PWideChar)
  : PWideChar; stdcall;

function CkRsa_SaveLastError(objHandle: HCkRsa; path: PWideChar)
  : wordbool; stdcall;

function CkRsa_SetX509Cert(objHandle: HCkRsa; cert: HCkCert;
  usePrivateKey: wordbool): wordbool; stdcall;

function CkRsa_SignBd(objHandle: HCkRsa; bdData: HCkBinData;
  hashAlgorithm: PWideChar; bdSig: HCkBinData): wordbool; stdcall;

function CkRsa_SignBytes(objHandle: HCkRsa; binaryData: HCkByteData;
  hashAlgorithm: PWideChar; outData: HCkByteData): wordbool; stdcall;

function CkRsa_SignBytesENC(objHandle: HCkRsa; binaryData: HCkByteData;
  hashAlgorithm: PWideChar; outStr: HCkString): wordbool; stdcall;

function CkRsa__signBytesENC(objHandle: HCkRsa; binaryData: HCkByteData;
  hashAlgorithm: PWideChar): PWideChar; stdcall;

function CkRsa_SignHash(objHandle: HCkRsa; hashBytes: HCkByteData;
  hashAlg: PWideChar; outData: HCkByteData): wordbool; stdcall;

function CkRsa_SignHashENC(objHandle: HCkRsa; encodedHash: PWideChar;
  hashAlg: PWideChar; outStr: HCkString): wordbool; stdcall;

function CkRsa__signHashENC(objHandle: HCkRsa; encodedHash: PWideChar;
  hashAlg: PWideChar): PWideChar; stdcall;

function CkRsa_SignString(objHandle: HCkRsa; strToBeHashed: PWideChar;
  hashAlgorithm: PWideChar; outData: HCkByteData): wordbool; stdcall;

function CkRsa_SignStringENC(objHandle: HCkRsa; strToBeHashed: PWideChar;
  hashAlgorithm: PWideChar; outStr: HCkString): wordbool; stdcall;

function CkRsa__signStringENC(objHandle: HCkRsa; strToBeHashed: PWideChar;
  hashAlgorithm: PWideChar): PWideChar; stdcall;

function CkRsa_SnkToXml(objHandle: HCkRsa; filename: PWideChar;
  outStr: HCkString): wordbool; stdcall;

function CkRsa__snkToXml(objHandle: HCkRsa; filename: PWideChar)
  : PWideChar; stdcall;

function CkRsa_UnlockComponent(objHandle: HCkRsa; unlockCode: PWideChar)
  : wordbool; stdcall;

function CkRsa_VerifyBd(objHandle: HCkRsa; bdData: HCkBinData;
  hashAlgorithm: PWideChar; bdSig: HCkBinData): wordbool; stdcall;

function CkRsa_VerifyBytes(objHandle: HCkRsa; originalData: HCkByteData;
  hashAlgorithm: PWideChar; signatureBytes: HCkByteData): wordbool; stdcall;

function CkRsa_VerifyBytesENC(objHandle: HCkRsa; originalData: HCkByteData;
  hashAlgorithm: PWideChar; encodedSig: PWideChar): wordbool; stdcall;

function CkRsa_VerifyHash(objHandle: HCkRsa; hashBytes: HCkByteData;
  hashAlg: PWideChar; sigBytes: HCkByteData): wordbool; stdcall;

function CkRsa_VerifyHashENC(objHandle: HCkRsa; encodedHash: PWideChar;
  hashAlg: PWideChar; encodedSig: PWideChar): wordbool; stdcall;

function CkRsa_VerifyPrivateKey(objHandle: HCkRsa; xml: PWideChar)
  : wordbool; stdcall;

function CkRsa_VerifyString(objHandle: HCkRsa; originalString: PWideChar;
  hashAlgorithm: PWideChar; binarySig: HCkByteData): wordbool; stdcall;

function CkRsa_VerifyStringENC(objHandle: HCkRsa; originalString: PWideChar;
  hashAlgorithm: PWideChar; encodedSig: PWideChar): wordbool; stdcall;
