...
procedure CkPrivateKey_getDebugLogFilePath(objHandle: HCkPrivateKey;
  outPropVal: HCkString); stdcall;

procedure CkPrivateKey_putDebugLogFilePath(objHandle: HCkPrivateKey;
  newPropVal: PWideChar); stdcall;

function CkPrivateKey__debugLogFilePath(objHandle: HCkPrivateKey)
  : PWideChar; stdcall;

procedure CkPrivateKey_getKeyType(objHandle: HCkPrivateKey;
  outPropVal: HCkString); stdcall;

function CkPrivateKey__keyType(objHandle: HCkPrivateKey): PWideChar; stdcall;

procedure CkPrivateKey_getLastErrorHtml(objHandle: HCkPrivateKey;
  outPropVal: HCkString); stdcall;

function CkPrivateKey__lastErrorHtml(objHandle: HCkPrivateKey)
  : PWideChar; stdcall;

procedure CkPrivateKey_getLastErrorText(objHandle: HCkPrivateKey;
  outPropVal: HCkString); stdcall;

function CkPrivateKey__lastErrorText(objHandle: HCkPrivateKey)
  : PWideChar; stdcall;

procedure CkPrivateKey_getLastErrorXml(objHandle: HCkPrivateKey;
  outPropVal: HCkString); stdcall;

function CkPrivateKey__lastErrorXml(objHandle: HCkPrivateKey)
  : PWideChar; stdcall;

function CkPrivateKey_getLastMethodSuccess(objHandle: HCkPrivateKey)
  : wordbool; stdcall;

procedure CkPrivateKey_putLastMethodSuccess(objHandle: HCkPrivateKey;
  newPropVal: wordbool); stdcall;

procedure CkPrivateKey_getPkcs8EncryptAlg(objHandle: HCkPrivateKey;
  outPropVal: HCkString); stdcall;

procedure CkPrivateKey_putPkcs8EncryptAlg(objHandle: HCkPrivateKey;
  newPropVal: PWideChar); stdcall;

function CkPrivateKey__pkcs8EncryptAlg(objHandle: HCkPrivateKey)
  : PWideChar; stdcall;

function CkPrivateKey_getVerboseLogging(objHandle: HCkPrivateKey)
  : wordbool; stdcall;

procedure CkPrivateKey_putVerboseLogging(objHandle: HCkPrivateKey;
  newPropVal: wordbool); stdcall;

procedure CkPrivateKey_getVersion(objHandle: HCkPrivateKey;
  outPropVal: HCkString); stdcall;

function CkPrivateKey__version(objHandle: HCkPrivateKey): PWideChar; stdcall;

function CkPrivateKey_GetJwk(objHandle: HCkPrivateKey; outStr: HCkString)
  : wordbool; stdcall;
...
function CkPrivateKey_GetPkcs1(objHandle: HCkPrivateKey; outData: HCkByteData)
  : wordbool; stdcall;

function CkPrivateKey_GetPkcs1ENC(objHandle: HCkPrivateKey; encoding: PWideChar;
  outStr: HCkString): wordbool; stdcall;

function CkPrivateKey__getPkcs1ENC(objHandle: HCkPrivateKey;
  encoding: PWideChar): PWideChar; stdcall;

function CkPrivateKey_GetPkcs1Pem(objHandle: HCkPrivateKey; outStr: HCkString)
  : wordbool; stdcall;

function CkPrivateKey__getPkcs1Pem(objHandle: HCkPrivateKey)
  : PWideChar; stdcall;

function CkPrivateKey_GetPkcs8(objHandle: HCkPrivateKey; outData: HCkByteData)
  : wordbool; stdcall;

function CkPrivateKey_GetPkcs8ENC(objHandle: HCkPrivateKey; encoding: PWideChar;
  outStr: HCkString): wordbool; stdcall;
...
function CkPrivateKey_GetPkcs8Encrypted(objHandle: HCkPrivateKey;
  password: PWideChar; outData: HCkByteData): wordbool; stdcall;

function CkPrivateKey_GetPkcs8EncryptedENC(objHandle: HCkPrivateKey;
  encoding: PWideChar; password: PWideChar; outStr: HCkString)
  : wordbool; stdcall;

function CkPrivateKey__getPkcs8EncryptedENC(objHandle: HCkPrivateKey;
  encoding: PWideChar; password: PWideChar): PWideChar; stdcall;

function CkPrivateKey_GetPkcs8EncryptedPem(objHandle: HCkPrivateKey;
  password: PWideChar; outStr: HCkString): wordbool; stdcall;

function CkPrivateKey__getPkcs8EncryptedPem(objHandle: HCkPrivateKey;
  password: PWideChar): PWideChar; stdcall;

function CkPrivateKey_GetPkcs8Pem(objHandle: HCkPrivateKey; outStr: HCkString)
  : wordbool; stdcall;

function CkPrivateKey__getPkcs8Pem(objHandle: HCkPrivateKey)
  : PWideChar; stdcall;

function CkPrivateKey_GetPublicKey(objHandle: HCkPrivateKey)
  : HCkPublicKey; stdcall;

function CkPrivateKey_GetRawHex(objHandle: HCkPrivateKey;
  pubKey: HCkStringBuilder; outStr: HCkString): wordbool; stdcall;

function CkPrivateKey__getRawHex(objHandle: HCkPrivateKey;
  pubKey: HCkStringBuilder): PWideChar; stdcall;

function CkPrivateKey_GetRsaDer(objHandle: HCkPrivateKey; outData: HCkByteData)
  : wordbool; stdcall;

function CkPrivateKey_GetRsaPem(objHandle: HCkPrivateKey; outStr: HCkString)
  : wordbool; stdcall;

function CkPrivateKey__getRsaPem(objHandle: HCkPrivateKey): PWideChar; stdcall;

function CkPrivateKey_GetXml(objHandle: HCkPrivateKey; outStr: HCkString)
  : wordbool; stdcall;
...
function CkPrivateKey_LoadAnyFormat(objHandle: HCkPrivateKey;
  privKeyData: HCkBinData; password: PWideChar): wordbool; stdcall;

function CkPrivateKey_LoadAnyFormatFile(objHandle: HCkPrivateKey;
  path: PWideChar; password: PWideChar): wordbool; stdcall;

function CkPrivateKey_LoadEd25519(objHandle: HCkPrivateKey; privKey: PWideChar;
  pubKey: PWideChar): wordbool; stdcall;

function CkPrivateKey_LoadEncryptedPem(objHandle: HCkPrivateKey;
  pemStr: PWideChar; password: PWideChar): wordbool; stdcall;

function CkPrivateKey_LoadEncryptedPemFile(objHandle: HCkPrivateKey;
  path: PWideChar; password: PWideChar): wordbool; stdcall;

function CkPrivateKey_LoadJwk(objHandle: HCkPrivateKey; jsonStr: PWideChar)
  : wordbool; stdcall;

function CkPrivateKey_LoadPem(objHandle: HCkPrivateKey; str: PWideChar)
  : wordbool; stdcall;

function CkPrivateKey_LoadPemFile(objHandle: HCkPrivateKey; path: PWideChar)
  : wordbool; stdcall;

function CkPrivateKey_LoadPkcs1(objHandle: HCkPrivateKey; data: HCkByteData)
  : wordbool; stdcall;

function CkPrivateKey_LoadPkcs1File(objHandle: HCkPrivateKey; path: PWideChar)
  : wordbool; stdcall;

function CkPrivateKey_LoadPkcs8(objHandle: HCkPrivateKey; data: HCkByteData)
  : wordbool; stdcall;

function CkPrivateKey_LoadPkcs8Encrypted(objHandle: HCkPrivateKey;
  data: HCkByteData; password: PWideChar): wordbool; stdcall;

function CkPrivateKey_LoadPkcs8EncryptedFile(objHandle: HCkPrivateKey;
  path: PWideChar; password: PWideChar): wordbool; stdcall;

function CkPrivateKey_LoadPkcs8File(objHandle: HCkPrivateKey; path: PWideChar)
  : wordbool; stdcall;

function CkPrivateKey_LoadPvk(objHandle: HCkPrivateKey; data: HCkByteData;
  password: PWideChar): wordbool; stdcall;

function CkPrivateKey_LoadPvkFile(objHandle: HCkPrivateKey; path: PWideChar;
  password: PWideChar): wordbool; stdcall;

function CkPrivateKey_LoadRsaDer(objHandle: HCkPrivateKey; data: HCkByteData)
  : wordbool; stdcall;

function CkPrivateKey_LoadRsaDerFile(objHandle: HCkPrivateKey; path: PWideChar)
  : wordbool; stdcall;

function CkPrivateKey_LoadXml(objHandle: HCkPrivateKey; xml: PWideChar)
  : wordbool; stdcall;

function CkPrivateKey_LoadXmlFile(objHandle: HCkPrivateKey; path: PWideChar)
  : wordbool; stdcall;

function CkPrivateKey_SaveLastError(objHandle: HCkPrivateKey; path: PWideChar)
  : wordbool; stdcall;

function CkPrivateKey_SavePemFile(objHandle: HCkPrivateKey; path: PWideChar)
  : wordbool; stdcall;

function CkPrivateKey_SavePkcs1File(objHandle: HCkPrivateKey; path: PWideChar)
  : wordbool; stdcall;

function CkPrivateKey_SavePkcs8EncryptedFile(objHandle: HCkPrivateKey;
  password: PWideChar; path: PWideChar): wordbool; stdcall;

function CkPrivateKey_SavePkcs8EncryptedPemFile(objHandle: HCkPrivateKey;
  password: PWideChar; path: PWideChar): wordbool; stdcall;

function CkPrivateKey_SavePkcs8File(objHandle: HCkPrivateKey; path: PWideChar)
  : wordbool; stdcall;

function CkPrivateKey_SavePkcs8PemFile(objHandle: HCkPrivateKey;
  path: PWideChar): wordbool; stdcall;

function CkPrivateKey_SaveRsaDerFile(objHandle: HCkPrivateKey; path: PWideChar)
  : wordbool; stdcall;

function CkPrivateKey_SaveRsaPemFile(objHandle: HCkPrivateKey; path: PWideChar)
  : wordbool; stdcall;

function CkPrivateKey_SaveXmlFile(objHandle: HCkPrivateKey; path: PWideChar)
  : wordbool; stdcall;
